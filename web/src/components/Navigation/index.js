...
const Navigation = () => {
  ...
  return (
    <Disclosure as="div" className="relative">
      <div className="">
        <div className="flex items-center justify-between py-4 px-4 px-4 sm:px-4 sm:px-4 md:justify-start md:space-x-10">
        ...
        <div className="hidden bg-green-800 py-3 md:block">
