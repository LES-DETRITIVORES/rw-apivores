        ...
        >
          ...
          >
            <div className="relative">
              ...
              />
              <Combobox.Input
                className="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-sm text-gray-800 placeholder-gray-400 focus:ring-0 focus:outline-none"
                placeholder="Search..."
