        ...
        <tbody>
          {sites.map((site) => (
            <tr key={site.id}>
              ...
              <td>{truncate(site.adresse2)}</td>
              <td>{truncate(site.codePostal)}</td>
              <td>{truncate(site.ville)}</td>
              <td>{truncate(site.latitude)}</td>
              <td>{truncate(site.longitude)}</td>
              <td>{truncate(site.etage)}</td>
