...
CREATE TABLE "new_Task" (
    ...
    "title" TEXT,
    CONSTRAINT "Task_workerId_fkey" FOREIGN KEY ("workerId") REFERENCES "Worker" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    ...
    CONSTRAINT "Task_materialId_fkey" FOREIGN KEY ("materialId") REFERENCES "Material" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Task_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Service" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Task" ("containerId", "customerId", "end", "id", "materialId", "plannedAt", "serviceId", "siteId", "start", "title", "workerId") SELECT "containerId", "customerId", "end", "id", "materialId", "plannedAt", "serviceId", "siteId", "start", "title", "workerId" FROM "Task";
DROP TABLE "Task";
